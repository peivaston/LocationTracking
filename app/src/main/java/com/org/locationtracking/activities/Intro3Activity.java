...
import com.org.locationtracking.databinding.ActivityIntro3Binding;

public class Intro3Activity
        extends AppCompatActivity
{

    private ActivityIntro3Binding mBinding;

    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_intro3);
        initControls();
    }

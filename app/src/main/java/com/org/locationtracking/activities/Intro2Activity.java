...
import com.org.locationtracking.databinding.ActivityIntro2Binding;

public class Intro2Activity
        extends AppCompatActivity
{

    private ActivityIntro2Binding mBinding;

    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_intro2);
        initControls();
    }
